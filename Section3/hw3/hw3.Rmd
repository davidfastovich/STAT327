...
lapply(red.vg[1], FUN = par.chan.filtering, k = 5, dim.x = dim(red.vg))
lapply(green.vg[1], FUN = par.chan.filtering, k = 5, dim.x = dim(green.vg))
lapply(blue.vg[1], FUN = par.chan.filtering, k = 5, dim.x = dim(blue.vg))
```